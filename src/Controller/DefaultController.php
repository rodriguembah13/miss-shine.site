...
class DefaultController extends AbstractController
{
    ...
    public function sendpaiement(Request $request): Response
    {
        ...
        $data = [
            ...
            'redirectUrl' => $this->params->get('domain') .$this->generateUrl('redirectpaiement', ['item' => $reference]), //$this->siteUrl . $this->SUCCESS_REDIRECT_URL . $orderIdString,
            "redirectOnFailureUrl" => $this->params->get('domain') .$this->generateUrl('redirectpaiement', ['item' => $reference]),
